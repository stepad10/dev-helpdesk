...
describe('MessageBubble Component', () => {
  ...
  it('parses and renders citation badges for DOC-XXX patterns', () => {
    const message: Message = { role: 'assistant', content: 'According to DOC-123 and DOC-456, you must reboot.' };
  ...
  it('does not render duplicate citation badges', () => {
    const message: Message = { role: 'assistant', content: 'DOC-999 is important. Again, see DOC-999.' };
    render(<MessageBubble message={message} />);
